...
const register = async (req, res) => {
  try {
    const { name, mobileNumber, yearOfPassOut, username, email, password } = req.body;

    if (!(name && mobileNumber && yearOfPassOut && username && email && password)) {
...
const updateUser = async (req, res) => {
  try {
    const { userId, name, mobileNumber, yearOfPassOut, biography } = req.body;
    ...
    if (yearOfPassOut) {
      user.yearOfPassOut = yearOfPassOut;
    }
    if (biography) {
